  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-8 font-mono">
      <div className="max-w-3xl mx-auto space-y-6">
        <header>
          <h1 className="text-2xl font-bold">Central Air Compressor</h1>
          <p className="text-slate-400 text-sm mt-1">urn:dataspace:plant1:equipment:compressor:central:001</p>
          <p className="text-slate-500 text-xs mt-1">ECLASS 27-30-02-01 · IRDI 0173-1#01-AKD119#001 · porta 3009</p>
        </header>
