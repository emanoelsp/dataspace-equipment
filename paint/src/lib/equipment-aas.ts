...
export function validateAccessToken(rawToken: string | null): TokenValidationResult {
  ...
  if (!envToken) return { valid: true } // sem token configurado = acesso aberto
...
export function buildNameplateSubmodel(id: string, data: {
  ...
  return {
    ...
    submodelElements: [
      ...
      prop("CountryOfOrigin", "xs:string", data.countryOfOrigin ?? "JP", "0173-1#02-AAO259#004", "País de origem"),
    ],
  }
}
