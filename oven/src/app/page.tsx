  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-8 font-mono">
      <div className="max-w-3xl mx-auto space-y-6">
        <header>
          <h1 className="text-2xl font-bold">Heat Treatment Furnace</h1>
          <p className="text-slate-400 text-sm mt-1">urn:dataspace:plant1:equipment:oven:heattreat:001</p>
          <p className="text-slate-500 text-xs mt-1">ECLASS 27-01-07-05 · IRDI 0173-1#01-AGE412#001 · porta 3004</p>
        </header>
